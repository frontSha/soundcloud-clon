...
export default function page() {
  ...
  const handleClick = (val) => {
    ...
    router.push(`${pathname}?${filterParams.toString()}`, { scroll: false });
  }

  const isActive = searchParams.get('type') ?? 'all';
          ...
          <div className="md:flex-1 md:*:mb-12 *:mb-8">
            {!query && (
              <div className="flex flex-col items-center pt-38">
                ...
                <h2 className="text-heading2 font-semibold mt-12">
                  Buscar pistas, artistas, podcasts y listas en SoundCloud.
                </h2>
              </div>
            )}
            {query &&
