  ...
  const sections = [
    {
      ...
      collection: recommendedPlaylists,
    },
    {
    ...
    <div id="content">
      ...
      <div className="wrapper-desktop-responsive max-w-[1240px] mx-auto max-lg:w-[960px] max-xl:w-[1080px] max-md:hidden">
        ...
        <div className="text-center">
          <h2 className="text-heading2 font-semibold pt-12 mb-16">
            Escucha la música del momento gratis en la comunidad SoundCloud
          </h2>
          <div className="mt-2.5 mb-5">
            <Button text={'Explora las listas de moda'} variant="primary" cta />
          </div>
        </div>
        <div id="creators" className="h-[350px]">
          <div className="bg-[url('https://a-v2.sndcdn.com/assets/images/hp_creator_image_featured_artists-798050ae.jpg')] bg-no-repeat bg-cover bg-right h-full w-auto pl-35 pr-[570px]">
            <div className="creator-info flex flex-col justify-center h-full">
              <h2 className="text-[2.571rem]/[100%] max-lg:text-heading1">
                Llamada a todos los <br />
                creadores
              </h2>
              <p className="text-heading3 font-semibold mt-12 mb-5">
        ...
        <div id="signup" className="h-[350px]">
          <div className="signup-content text-center flex flex-col justify-center h-full">
            <h2 className="text-[2.571rem]/[100%]">
              Gracias por escuchar, ahora únete.
            </h2>
            <p className="text-heading3 font-semibold mt-12 mb-5">
      ...
      <div className="wrapper-mobile md:hidden relative min-w-[370px]">
        <div id="header" className="bg-base sticky top-0 left-0 z-50">
          <div className="px-8 py-4 flex justify-between items-center">
            <div className="logo">
              <svg
                className="min-[758px]:hidden h-10"
                id="header-logo"
                viewBox="0 0 143 64"
              ...
              <svg
                className="max-[758px]:hidden h-10"
                id="header-logo-wordmark"
                viewBox="0 0 418 50"
                xmlns="http://www.w3.org/2000/svg"
                aria-hidden="false"
              >
        ...
        <div id="hero" className="relative">
          <div className="hero-img-wrapper w-full h-full">
            <img
              ...
              alt="Los últimos lanzamientos llegan primero a SoundCloud"
              className="object-cover w-full"
            />
          </div>
          <div className="hero-content px-8 pb-10 absolute bottom-0 left-0 right-0 flex flex-col gap-8">
            <h1 className="text-heading1 min-[758px]:text-[2.571rem]/[1.2] font-semibold">
              Los últimos lanzamientos llegan primero a SoundCloud
            </h1>
            <Button
